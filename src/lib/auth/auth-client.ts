...
export const NAME_TOKEN_KEY = "Swaam_auth_token_client";

// Helper to decode base64url strings (used for JWT payloads)
...
// Decodes the payload of a JWT to check for expiration
