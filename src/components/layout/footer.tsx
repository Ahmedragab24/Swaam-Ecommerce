  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        {/* Grid Sections */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-10 gap-x-10 mb-10">
          {/* Info Section */}
          <div
          ...
          >
            ...
            <div className="space-y-2 text-sm md:text-base">
              ...
              <div className="flex items-center justify-center sm:justify-start gap-2 text-sm md:text-base">
